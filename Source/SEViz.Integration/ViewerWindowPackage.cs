//------------------------------------------------------------------------------
// <copyright file="ViewerWindowPackage.cs" company="Company">
...
namespace SEViz.Integration
{
    ...
    {
        /// <summary>
        /// ViewerWindowPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "9eb934d0-0423-4cf8-9eb9-0fd0a25a1d5a";

        /// <summary>
        /// Initializes a new instance of the <see cref="ViewerWindow"/> class.
        /// </summary>
        public ViewerWindowPackage()
        {
